	...
	return apply_filters(
		'storely_get_slider5_default', json_encode(
				...
				array(
					'image_url'       => ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/storely/assets/images/slider/slide-bg1.png',
					'image_url2'       => ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/storely/assets/images/slider/slide-img1.png',
					'title'           => esc_html__( 'New Season Dresses', 'storely-pro' ),
					'subtitle'         => esc_html__( 'UP TO', 'storely-pro' ),
					'subtitle2'         => esc_html__( '70% OFF', 'storely-pro' ),
					'subtitle3'         => esc_html__( 'Starting At', 'storely-pro' ),
					'subtitle4'         => esc_html__( '$40.00', 'storely-pro' ),
					'text'            => esc_html__( 'Lorem ipsum dolor sit amet consectetur  adipiscing elited do veniam.', 'storely-pro' ),
					'text2'	  =>  esc_html__( 'Shop Now', 'storely-pro' ),
					'link'	  =>  esc_html__( '#', 'storely-pro' ),
					"slide_align" => "left", 
