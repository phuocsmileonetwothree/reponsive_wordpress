...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	if( 'Shoply' == $theme->name  || 'Storess' == $theme->name){	
	...
	//Pro feature
		class storely_service__section_premium extends WP_Customize_Control {
			...
			?>
				<a class="customizer_service_section_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Service Available in the Premium Version','ecommerce-companion'); ?></a>
