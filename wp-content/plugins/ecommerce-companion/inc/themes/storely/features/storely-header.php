...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';	
	 ...
	 */
		...
		class storely_header_social_premium extends WP_Customize_Control {
			...
			?>
				<a class="customizer_header_social_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Icons Available in the Premium Version','ecommerce-companion'); ?></a>
			<?php }else{ ?>	
				<a class="customizer_header_social_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Icons Available in the Premium Version','ecommerce-companion'); ?></a>				
			<?php
			}}
