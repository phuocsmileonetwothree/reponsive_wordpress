...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_setting( 'footer_above_content', 
		...
		class storely_footer_above_premium extends WP_Customize_Control {
			...
			?>
				<a class="customizer_footer_above_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Info Available in the Premium Version','ecommerce-companion'); ?></a>
			<?php }else{ ?>		
				<a class="customizer_footer_above_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Info Available in the Premium Version','ecommerce-companion'); ?></a>
			<?php
			}}
	...
	$wp_customize->add_setting( 'footer_widget_left_content', 
		...
		class storely_footer_address_premium extends WP_Customize_Control {
			...
			if( 'Shoply' == $theme->name){
			?>
				<a class="customizer_footer_address_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Address Available in the Premium Version','ecommerce-companion'); ?></a>
			<?php }else{ ?>		
				<a class="customizer_footer_address_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Address Available in the Premium Version','ecommerce-companion'); ?></a>
			<?php
			}}
