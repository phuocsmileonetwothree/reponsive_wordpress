...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	 ...
	 */
		...
		class storely_banner_info__section_premium extends WP_Customize_Control {
			...
			?>
				<a class="customizer_banner_info_section_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Banner Info Available in the Premium Version','ecommerce-companion'); ?></a>
			<?php }else{ ?>		
				<a class="customizer_banner_info_section_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Banner Info Available in the Premium Version','ecommerce-companion'); ?></a>
			<?php
			}}
