...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_setting( 'slider3', 
		...
		$wp_customize->add_control( 
			new Storely_Repeater( $wp_customize, 
				'slider3', 
					array(
						'label'   => esc_html__('Slide','storely-pro'),
						'section' => 'slider_setting',
		...
		class storely_slider__section_premium extends WP_Customize_Control {
			...
			?>
				<a class="customizer_slider_section_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Slides Available in the Premium Version','ecommerce-companion'); ?></a>
	...
	'slider_info_left_head',
		array(
			'type' => 'hidden',
			'label' => __('Slider Info Left','storely-pro'),
			'section' => 'slider_setting',
		)
	);
	...
	'slider_info_left_hs',
		array(
			'type' => 'checkbox',
			'label' => __('Hide / Show','storely-pro'),
			'section' => 'slider_setting',
		)
	);
		...
		$wp_customize->add_control( 
			new Storely_Repeater( $wp_customize, 
				'slider_info_left_img', 
					array(
						'label'   => esc_html__('Images','storely-pro'),
						'section' => 'slider_setting',
	...
	$wp_customize->add_setting(
    	...
    	array(
	        'default'			=> __('Women Fashion','storely-pro'),
			'capability'     	=> 'edit_theme_options',
	...
	$wp_customize->add_setting(
    	...
    	array(
	        'default'			=> __('Shop Now','storely-pro'),
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'storely_sanitize_html',
			'transport'         => $selective_refresh,
			'priority' => 15,
	...
	$wp_customize->add_control( 
		'slider_info_left_btn_lbl',
		array(
		    'label'   => __('Button Label','storely-pro'),
		    'section' => 'slider_setting',
			'type'           => 'text',
		)  
	);
	...
	$wp_customize->add_control( 
		'slider_info_left_btn_url',
		array(
		    'label'   => __('Button Link','storely-pro'),
		    'section' => 'slider_setting',
			'type'           => 'text',
		)  
	);
	...
	$wp_customize->add_setting( 'slider_info2', 
		...
		$wp_customize->add_control( 
			new Storely_Repeater( $wp_customize, 
				'slider_info2', 
					array(
						'label'   => esc_html__('Slider Info','storely-pro'),
						'section' => 'slider_setting',
		...
		class storely_slider_info_section_premium extends WP_Customize_Control {
			public function render_content() { 
			?>
				<a class="customizer_slider_info_section_premium up-to-pro" href="https://sellerthemes.com/storely/" target="_blank" style="display: none;"><?php _e('More Info Available in the Premium Version','ecommerce-companion'); ?></a>
